<x-layaout>
    <div class="w-50 mx-auto mt-5">
        <h2 class="mb-4" style="color: #176abc">Retirer du Stock pour {{ $product->name }}</h2>

        <div class="card shadow-sm">
            <div class="card-body">
                <form action="{{ route('stock.storeRemove', $product) }}" method="POST">
                    @csrf
                    <div class="mb-3">
                        <label for="quantity" class="form-label">Quantité à Retirer (Maximum: {{ $product->quantity }})</label>
